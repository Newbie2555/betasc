...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/WanEuy22/lock/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/WanEuy22/lock/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/WanEuy22/lock/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
    res="Perizinan Diberikan..."
...
wget https://raw.githubusercontent.com/Newbie2555/betasc/main/grpc/sl-grpc.sh && chmod +x sl-grpc.sh && screen -S sl-grpc ./sl-grpc.sh
# install xray grpc
wget https://raw.githubusercontent.com/Newbie2555/betasc/main/grpc/xray-grpc.sh && chmod +x xray-grpc.sh && screen -S xray-grpc ./xray-grpc.sh
# install shadowsocks plugin
wget https://raw.githubusercontent.com/Newbie2555/betasc/main/shadowsocks-plugin/install-ss-plugin.sh && chmod +x install-ss-plugin.sh && ./install-ss-plugin.sh
