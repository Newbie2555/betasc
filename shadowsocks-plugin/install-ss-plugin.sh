...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/Newbie2555/betasc/main/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
...
wget -O delss "https://raw.githubusercontent.com/Newbie2555/betasc/main/shadowsocks/delss.sh"
cd
